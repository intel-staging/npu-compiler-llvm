...
// expected-error@+1 {{expected ':'}}
!qalias = !quant.quantile<i8<16>:f32, {-1.0,1.0}:0.99872:127>

// -----
// Unrecognized token: missing closing angle bracket
// expected-error@+1 {{unbalanced '<' character in pretty dialect name}}
!qalias = !quant<quantile<i8<-4:3:f32, {-1.0,1.0}:0.99872:127>>
...
// expected-error@+1 {{expected floating point literal}}
!qalias = !quant.quantile<i8<-4:3>:f32, {}:0.99872:127>

// -----
// Illegal quantile params: missing quantile values
// expected-error@+1 {{expected floating point literal}}
!qalias = !quant.quantile<i8<-4:3>:f32, {-1.0,}:0.99872:127>
